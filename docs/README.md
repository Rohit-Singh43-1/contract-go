...
- `"private key is encrypted but no password provided"` - Encrypted private key detected without password
...
- `"no Confidential Computing image matching version found"` - No images match the version constraint
